...
public final class RSSReader {
    ...
    private static void processItem(XMLTree item, SimpleWriter out) {
        ...
        /**
         * method call to find index of child with label 'title' among item's
         * children
         **/
        ...
        if (indexOfTitle != -1) {
            ...
            out.println("<td>No title available</td></tr>");
        }
    }
    ...
    public static void main(String[] args) {
        ...
        /**
         * pass the child of rss i.e. channel & SimpleWriter object 'output' to
         * print to the user-named output file
         **/
        outputHeader(rss.child(0), output);
